...
public class Scrutiny_MarkDialog_R15 extends Activity implements
...
//	EditText tv_grand_toal;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.scrutiny_mark_dialog_R15_btech);
		setContentView(R.layout.scrutiny_r15_nototal);
		...
		R15BTech=instanceUtitlity  
				.isRegulation_R15_Btech(Scrutiny_MarkDialog_R15.this);
		if (R15BTech) {
			 A1Limit="3";
			 A1TotalLimit="25";
			 RowTotalLimit="10";
...
//						tv_grand_toal);
	...
	private void showRemarksInETWithGreenColor(String C_REMARK,
		...
		if (!TextUtils.isEmpty(C_REMARK)) {
			...
			PeditText.setOnClickListener(Scrutiny_MarkDialog_R15.this);
...
Log.v("remark", remarksList[which].toString());
						...
						// et.requestFocus();
						// et.setOnClickListener(Scrutiny_MarkDialog_R15_Mtech.this);
						et.setError(null);
						et.setFocusableInTouchMode(false);
						et.setOnClickListener(Scrutiny_MarkDialog_R15.this);
						et.clearFocus();
						dialog.dismiss();
		...
		if (text.equals("") && tag.equals("")) {
			...
			if (mEditText.getCurrentTextColor() == getResources().getColor(
				...
				if(countButton<2){
					...
					mEditText.setOnClickListener(Scrutiny_MarkDialog_R15.this);
					check = true;
					}else{
...
//				tv_mark_10_11_total.setText("" + row_total_1011);
	...
	public void afterTextChanged(Editable s) {
		...
		//	setTextToFocusedView(arg0.toString());
			...
			if (focusedView != null && focusedView instanceof EditText) {
				EditText et_focusedView = ((EditText) focusedView);
				et_focusedView.removeTextChangedListener(Scrutiny_MarkDialog_R15.this);
				et_focusedView.setText("");
				et_focusedView.addTextChangedListener(Scrutiny_MarkDialog_R15.this);
			}
			}
			}catch(Exception e){
				e.printStackTrace();
