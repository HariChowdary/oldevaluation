...
public class Scrutiny_MarkDialogCorrection extends Activity implements
  ...
  */
		...
		if (R09BTech && !is_subject_code_special_case) {    
			...
			Boolean NRBTech = instanceUtitlity
					.isRegulation_NR_BTech_Course(Scrutiny_MarkDialogCorrection.this);
  			if(NRBTech){
				RowTotalLimit = "20";
				maxTotalMark = "100";
			}
...
//			.setVisibility(View.GONE);
	...
	public void afterTextChanged(Editable s) {
		...
		//	setTextToFocusedView(arg0.toString());
			...
			if (focusedView != null && focusedView instanceof EditText) {
				EditText et_focusedView = ((EditText) focusedView);
				et_focusedView.removeTextChangedListener(Scrutiny_MarkDialogCorrection.this);
				et_focusedView.setText("");
				et_focusedView.addTextChangedListener(Scrutiny_MarkDialogCorrection.this);
			}
			}
			}catch(Exception e){
				e.printStackTrace();
		...
		_mark4_total = mark;
			...
			if (!TextUtils.isEmpty(mark4a) ) {
				...
				if (!TextUtils.isEmpty(mark)) {
					if (Float.parseFloat(mark) > Float.parseFloat(""
							+ maxTotalMark_4)) {
						Toast.makeText(this, "Row Total Exceeds " + maxTotalMark_4,
								Toast.LENGTH_SHORT).show();
						View focusedView = getCurrentFocus();
						if (focusedView != null && focusedView instanceof EditText) {
							alertForInvalidMark(focusedView, true, " "
	...
	//Swapna
		if ( !is_subject_code_special_case) {
			...
			/*if (subjectCode
				...
				if(etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					...
					_max_value = SSConstants.SUBJ_54017_MACHINE_DRAWING_3_PART_A_SUB_QUES_MAX_TOTAL;
				}
				else if(etQuesNo == tv_mark2a){
					_max_value = SSConstants.SUBJ_54017_MACHINE_DRAWING_3_MAX_SUBTOTAL_FOR_PART_2;
				}
				else{
					_max_value = SSConstants.SUBJ_54017_MACHINE_DRAWING_3_MAX_SUBTOTAL_FOR_PART_1;
				}
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					|| etQuesNo == tv_mark1c || etQuesNo == tv_mark1d
					|| etQuesNo == tv_mark1e) {
				_max_value = SSConstants.R13_MTECH_MAXSUBTOTAL_1;
			} else {
				_max_value = SSConstants.R13_MTECH_MAXSUBTOTAL_2_TO_11;
			}
		}
		...
		if (subjectCode
			...
			if ((etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
				...
				_max_value = SSConstants.SUBJ_58002_DESIGN_AND_DRAWING_OF_IRRIGATION_STRUCTURES_1_MAX_SUBTOTAL_FOR_1_AND_2;
			} else if (etQuesNo == tv_mark3a || etQuesNo == tv_mark3b
					|| etQuesNo == tv_mark3c || etQuesNo == tv_mark3d
					|| etQuesNo == tv_mark4a || etQuesNo == tv_mark4b
					|| etQuesNo == tv_mark4c || etQuesNo == tv_mark4d) {
				_max_value = SSConstants.SUBJ_58002_DESIGN_AND_DRAWING_OF_IRRIGATION_STRUCTURES_1_MAX_SUBTOTAL_FOR_3_AND_4;
			}
		}
		...
		// K0129
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					...
					|| etQuesNo == tv_mark2a || etQuesNo == tv_mark2b
					|| etQuesNo == tv_mark2c || etQuesNo == tv_mark2d) {
				_max_value = SSConstants.SUBJ_K0129_DESIGN_AND_DRAWING_OF_HYDRAULIC_STRUCTURES_2_MAX_SUBTOTAL_FOR_1_AND_2;
			}
		}

		// changed on 8/01/2014
		// 54017
		else if (subjectCode
				.equalsIgnoreCase(SSConstants.SUBJ_54017_MACHINE_DRAWING_3)) {
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					|| etQuesNo == tv_mark1c || etQuesNo == tv_mark1d) {
				_max_value = SSConstants.SUBJ_54017_MACHINE_DRAWING_3_MAX_SUBTOTAL_FOR_PART_1;
			} else if (etQuesNo == tv_mark2a || etQuesNo == tv_mark2b
					|| etQuesNo == tv_mark2c || etQuesNo == tv_mark2d) {
				_max_value = SSConstants.SUBJ_54017_MACHINE_DRAWING_3_MAX_SUBTOTAL_FOR_PART_2;
			}
		}
		...
		// 54065
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					...
					|| etQuesNo == tv_mark3a || etQuesNo == tv_mark3b
					|| etQuesNo == tv_mark3c || etQuesNo == tv_mark3d) {
				_max_value = SSConstants.SUBJ_54065_MACHINE_DRAWING_AND_COMPUTER_AIDED_GRAPHICS_4_MAX_SUBTOTAL_FOR_1_2_AND_3;
			} else if (etQuesNo == tv_mark4a || etQuesNo == tv_mark4b
					|| etQuesNo == tv_mark4c || etQuesNo == tv_mark4d) {
				_max_value = SSConstants.SUBJ_54065_MACHINE_DRAWING_AND_COMPUTER_AIDED_GRAPHICS_4_MAX_SUBTOTAL_FOR_4;
			}
		...
		// T0121
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					...
					|| etQuesNo == tv_mark5a || etQuesNo == tv_mark5b
					|| etQuesNo == tv_mark5c || etQuesNo == tv_mark5d) {
				_max_value = SSConstants.SUBJ_T0121_BUILDING_PLANNING_AND_DRAWING_5_MAX_SUBTOTAL_FOR_PART_A;
			} else if (etQuesNo == tv_mark6a || etQuesNo == tv_mark6b
					|| etQuesNo == tv_mark6c || etQuesNo == tv_mark6d
					|| etQuesNo == tv_mark7a || etQuesNo == tv_mark7b
					|| etQuesNo == tv_mark7c || etQuesNo == tv_mark7d) {
				_max_value = SSConstants.SUBJ_T0121_BUILDING_PLANNING_AND_DRAWING_5_MAX_SUBTOTAL_FOR_PART_B;
			}
		}
		...
		// X0305
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					|| etQuesNo == tv_mark1c || etQuesNo == tv_mark1d) {
				_max_value = SSConstants.SUBJ_X0305_MACHINE_DRAWING_6_PART_A;
			} else if (etQuesNo == tv_mark2a || etQuesNo == tv_mark2b
					|| etQuesNo == tv_mark2c || etQuesNo == tv_mark2d) {
				_max_value = SSConstants.SUBJ_X0305_MACHINE_DRAWING_6_PART_B;
			}
		}
		...
		// V0323
			...
			if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
					...
					|| etQuesNo == tv_mark3a || etQuesNo == tv_mark3b
					|| etQuesNo == tv_mark3c || etQuesNo == tv_mark3d) {
				_max_value = SSConstants.SUBJ_V0323_MACHINE_DRAWING_7_MAXSUBTOTAL_FOR_1_2_AND_3;
			} else if (etQuesNo == tv_mark4a || etQuesNo == tv_mark4b
					|| etQuesNo == tv_mark4c || etQuesNo == tv_mark4d) {
				_max_value = SSConstants.SUBJ_V0323_MACHINE_DRAWING_7_MAXSUBTOTAL_FOR_4;
			}
		}*/
	...
	private boolean checkSubTotalforSpecialcaseSubjCode(String marks) {
		...
		if (is_subject_code_special_case) {
			...
			// if (subjectCode
			// .equalsIgnoreCase(SSConstants.SUBJ_54017_MACHINE_DRAWING_3)) {
			// if (!(Float.valueOf(marks) >
			// SSConstants.SUBJ_54017_MACHINE_DRAWING_3_PART_A_SUB_QUES_MAX_TOTAL))
			// {
			// flag = true;
			// } else {
			// flag = false;
	...
	private void setFocusablesForSpecialCaseSubjCodes() {
		...
		if (R09BTech && is_subject_code_special_case) {
			...
			// tv_mark2_total.setFocusable(false);
			// tv_mark3_total.setFocusable(false);
			// tv_mark4_total.setFocusable(false);
			// tv_mark5_total.setFocusable(false);
			// tv_mark6_total.setFocusable(false);
			// tv_mark7_total.setFocusable(false);
			// tv_mark8_total.setFocusable(false);
			//
			// tv_mark1_total.setFocusableInTouchMode(false);
			// tv_mark2_total.setFocusableInTouchMode(false);
			// tv_mark3_total.setFocusableInTouchMode(false);
			// tv_mark4_total.setFocusableInTouchMode(false);
			// tv_mark5_total.setFocusableInTouchMode(false);
			// tv_mark6_total.setFocusableInTouchMode(false);
			// tv_mark7_total.setFocusableInTouchMode(false);
			// tv_mark8_total.setFocusableInTouchMode(false);
		...
		else if( !is_subject_code_special_case){
			...
			// tv_mark4_total.setFocusableInTouchMode(true);
			//
			// tv_mark5_total.setFocusable(true);
			// tv_mark5_total.setFocusableInTouchMode(true);
			//
			// tv_mark6_total.setFocusable(true);
			// tv_mark6_total.setFocusableInTouchMode(true);
			...
			// tv_grand_toal.setFocusable(true);
			// tv_grand_toal.setFocusableInTouchMode(true);
			// tv_mark3_total.setOnClickListener(this);
			// tv_mark4_total.setOnClickListener(this);
			// tv_mark5_total.setOnClickListener(this);
			// tv_mark6_total.setOnClickListener(this);
			// tv_mark7_total.setOnClickListener(this);
			// tv_mark8_total.setOnClickListener(this);
		}
	}
	...
	private void disableEditTextForSpecialCaseSubjCode() {
		...
		if (R09BTech && is_subject_code_special_case) {
			...
			// 58002 or 54065 or V0323 or 54017
			if ( subjectCode
							.equalsIgnoreCase(SSConstants.SUBJ_54017_MACHINE_DRAWING_3) || 
				 subjectCode
							.equalsIgnoreCase(SSConstants.SUBJ_54065_MACHINE_DRAWING_AND_COMPUTER_AIDED_GRAPHICS_4) ||
		...
		// check regulation here
			...
			tv_mark8d.setOnClickListener(this);
			...
			tv_mark8e.setOnClickListener(this);
	...
	private void calculateGrandTotal() { 
		...
		if (!is_subject_code_special_case ) {
			...
			if (!TextUtils.isEmpty(mark)) {
				...
				_contentValues.put(SSConstants.R1_TOTAL, mark);
			}

			mark = _mark2_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R2_TOTAL, mark);
			}

			mark = _mark3_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R3_TOTAL, mark);
			}

			mark = _mark4_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R4_TOTAL, mark);
			}

			mark = _mark5_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R5_TOTAL, mark);
			}

			mark = _mark6_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R6_TOTAL, mark);
			}

			mark = _mark7_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R7_TOTAL, mark);
			}

			mark = _mark8_total;
			if (!TextUtils.isEmpty(mark)) {
				listTotalMarks.add(Float.valueOf(mark));
				_contentValues.put(SSConstants.R8_TOTAL, mark);
			}
			...
			if (!listTotalMarks.isEmpty()) {
				...
				if (listTotalMarks.size() < 6) {
					...
					_grand_total = "" + roundOffGrandTotal;
				} else {
					for (int i = 0; i < 5; i++) {
						grandTotal += listTotalMarks.get(i);
					}
		...
		// changed on 8/01/2014
				// 54065 or V0323 or 54017
					...
					// mark = tv_mark7_total.getText().toString().trim();
					// if (!TextUtils.isEmpty(mark)) {
					// listTotalMarks.add(Float.valueOf(mark));
					// _contentValues.put(SSConstants.R7_TOTAL, mark);
					// }
					//
					// mark = tv_mark8_total.getText().toString().trim();
					// if (!TextUtils.isEmpty(mark)) {
					// listTotalMarks.add(Float.valueOf(mark));
					// _contentValues.put(SSConstants.R8_TOTAL, mark);
					// }
	...
	private float checkRowTotalExceedsMaxValue(View view, String pMarks) {
		...
		case R.id.q1_a:
			if (is_subject_code_special_case) {
				if (!checkSubTotalforSpecialcaseSubjCode(pMarks)) {
					return SUB_TOTAL_EXCEEDS_MAX_MARKS_FOR_SPECIAL_CASE_SUBJ_CODES;
				}

				// 54017 or X0305
				if (subjectCode
						.equalsIgnoreCase(SSConstants.SUBJ_X0305_MACHINE_DRAWING_6)) {
					// get best of 2 marks from sub ques 1
					_fl_total_row_mark = selectBestof2();
					if (_fl_total_row_mark != SUB_TOTAL_EXCEEDS_MAX_MARKS_FOR_SPECIAL_CASE_SUBJ_CODES) {
