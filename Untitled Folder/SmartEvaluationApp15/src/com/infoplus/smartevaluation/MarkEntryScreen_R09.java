...
public class MarkEntryScreen_R09 extends Activity implements OnClickListener,
		TextWatcher {
	...
	int RowTotalLimit_4 = 45;
	//int RowTotalLimit_3 = 16;
	int RowTotalLimit_2 = 32;
	...
	// EditText tv_mark1_total, tv_mark_2_total, tv_mark_3_total,
	// tv_mark_4_total,
...
String startTime;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		R09BTech = instanceUtility.isRegulation_R09_Course(this);
		...
		Boolean NRBTech = instanceUtility.isRegulation_NR_Course(this);
		...
		if (R09BTech && NRBTech) {
			...
			if (R09BTech
					&& subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_Z1221_ENGINEERING_DRAWING)
					|| subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_Z0223_ENGINEERING_DRAWING)
					|| subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_Z0423_ENGINEERING_DRAWING)
					|| subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_Z0522_ENGINEERING_DRAWING)
					|| subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_X0221_ENGINEERING_DRAWING)) {
				RowTotalLimit = 16;
				RowTotalLimit_2 = 32;
				GrandTotalLimit = 80;
			} else {
		 ...
		 * tv_grand_total.setFocusable(false); tv_txt_grand.setFocusable(false);
		 * tv_total.setFocusable(false);
		 */
		showItems();
		CountDownTimer myCountdownTimer = new CountDownTimer(
				SEConstants.time_limit
				/* getTimeLimit() */, 1000) {
	...
	private void disableEditTextForSpecialCaseSubjCode() {  
		if (is_subject_code_special_case) {
			...
			if (subjectCode
				...
				if (subjectCode
						.equalsIgnoreCase(SEConstants.SUBJ_K0129_DESIGN_AND_DRAWING_OF_HYDRAULIC_STRUCTURES_2)) {
					((EditText) findViewById(R.id.q3_a)).setEnabled(false);
					((EditText) findViewById(R.id.q3_b)).setEnabled(false);
					((EditText) findViewById(R.id.q3_c)).setEnabled(false);
					((EditText) findViewById(R.id.q3_d)).setEnabled(false);
					((EditText) findViewById(R.id.q4_a)).setEnabled(false);
					((EditText) findViewById(R.id.q4_b)).setEnabled(false);
					((EditText) findViewById(R.id.q4_c)).setEnabled(false);
					((EditText) findViewById(R.id.q4_d)).setEnabled(false);
				}
	...
	public void switchToShowGrandTotalSummaryTableActivity(View view) {
		...
		new AsyncTask<Void, Void, Void>() {
			...
			protected void onPostExecute(Void result) {
				...
				Intent intent = new Intent(MarkEntryScreen_R09.this,
	...
	public void showProgress(String msg) {
		if (progressDialog == null || !progressDialog.isShowing()) {
			progressDialog = ProgressDialog.show(MarkEntryScreen_R09.this, "",
					msg);
		...
		if (!is_subject_code_special_case) {
			...
			if (subjectCode
				...
				if (etQuesNo == tv_mark1a || etQuesNo == tv_mark1b
						...
						|| etQuesNo == tv_mark5c || etQuesNo == tv_mark5d) {
					_max_value = RowTotalLimit;
				} else if (etQuesNo == tv_mark6a || etQuesNo == tv_mark6b
						|| etQuesNo == tv_mark6c || etQuesNo == tv_mark6d
						|| etQuesNo == tv_mark7a || etQuesNo == tv_mark7b
						|| etQuesNo == tv_mark7c || etQuesNo == tv_mark7d) {
					_max_value = RowTotalLimit_4;
				}
				...
				if (subjectCode
						.equalsIgnoreCase(SEConstants.SUBJ_Q0123_ENGINEERING_DRAWING)) {
					if (etQuesNo == tv_mark3a || etQuesNo == tv_mark3b
							|| etQuesNo == tv_mark3c || etQuesNo == tv_mark3d
							|| etQuesNo == tv_mark4a || etQuesNo == tv_mark4b
							|| etQuesNo == tv_mark4c || etQuesNo == tv_mark4d
							|| etQuesNo == tv_mark5a || etQuesNo == tv_mark5b
	...
	private float checkRowTotalExceedsMaxValue(View view, String pMarks) {
		...
		if (!is_subject_code_special_case) {
			if (view.getId() == R.id.q1_a || view.getId() == R.id.q1_b
					...
					|| view.getId() == R.id.q1_e || view.getId() == R.id.q2_a
					|| view.getId() == R.id.q2_b || view.getId() == R.id.q2_c
					|| view.getId() == R.id.q2_d || view.getId() == R.id.q2_e
					|| view.getId() == R.id.q3_a || view.getId() == R.id.q3_b
					|| view.getId() == R.id.q3_c || view.getId() == R.id.q3_d
					|| view.getId() == R.id.q3_e || view.getId() == R.id.q4_a
					|| view.getId() == R.id.q4_b || view.getId() == R.id.q4_c
					|| view.getId() == R.id.q4_d || view.getId() == R.id.q4_e
					|| view.getId() == R.id.q5_a || view.getId() == R.id.q5_b
					|| view.getId() == R.id.q5_c || view.getId() == R.id.q5_d
					|| view.getId() == R.id.q5_e || view.getId() == R.id.q6_a
					|| view.getId() == R.id.q6_b || view.getId() == R.id.q6_c
					|| view.getId() == R.id.q6_d || view.getId() == R.id.q6_e
					|| view.getId() == R.id.q7_a || view.getId() == R.id.q7_b
					|| view.getId() == R.id.q7_c || view.getId() == R.id.q7_d
					|| view.getId() == R.id.q7_e || view.getId() == R.id.q8_a
					|| view.getId() == R.id.q8_b || view.getId() == R.id.q8_c
					|| view.getId() == R.id.q8_d || view.getId() == R.id.q8_e) {
				value = RowTotalLimit;
			...
			if (subjectCode
					...
					|| subjectCode
							.equalsIgnoreCase(SEConstants.SUBJ_X0305_MACHINE_DRAWING_6)) {
				if (view.getId() == R.id.q1_a || view.getId() == R.id.q1_b
						|| view.getId() == R.id.q1_c
						|| view.getId() == R.id.q1_d
						|| view.getId() == R.id.q2_a
						|| view.getId() == R.id.q2_b
						|| view.getId() == R.id.q2_c
						|| view.getId() == R.id.q2_d
						|| view.getId() == R.id.q3_a
						|| view.getId() == R.id.q3_b
						|| view.getId() == R.id.q3_c
						|| view.getId() == R.id.q3_d) {
					value = RowTotalLimit;
				} else if (view.getId() == R.id.q4_a) {
					value = RowTotalLimit_4;
				}
			} else if (subjectCode
					.equalsIgnoreCase(SEConstants.SUBJ_T0121_BUILDING_PLANNING_AND_DRAWING_5)) {
				if (view.getId() == R.id.q1_a || view.getId() == R.id.q1_b
						...
						|| view.getId() == R.id.q3_c
						|| view.getId() == R.id.q3_d
						|| view.getId() == R.id.q4_a
						|| view.getId() == R.id.q4_b
						|| view.getId() == R.id.q4_c
						|| view.getId() == R.id.q4_d
						|| view.getId() == R.id.q5_a
						|| view.getId() == R.id.q5_b
						|| view.getId() == R.id.q5_c
						|| view.getId() == R.id.q5_d) {
					value = RowTotalLimit;
				} else if (view.getId() == R.id.q6_a
						|| view.getId() == R.id.q6_b
						|| view.getId() == R.id.q6_c
						|| view.getId() == R.id.q6_d
						|| view.getId() == R.id.q7_a
						|| view.getId() == R.id.q7_b
						|| view.getId() == R.id.q7_c
						|| view.getId() == R.id.q7_d) {
					value = RowTotalLimit_4;
				}
				...
				if (subjectCode
						.equalsIgnoreCase(SEConstants.SUBJ_Q0123_ENGINEERING_DRAWING)) {
					if (view.getId() == R.id.q3_a || view.getId() == R.id.q3_b
							|| view.getId() == R.id.q3_c
							|| view.getId() == R.id.q3_d
							|| view.getId() == R.id.q4_a
							|| view.getId() == R.id.q4_b
		...
		try {
			if (!clickFind) {
				...
				if (focusedView != null && focusedView instanceof EditText) {
					EditText et_focusedView = ((EditText) focusedView);
					et_focusedView
							.removeTextChangedListener(MarkEntryScreen_R09.this);
					et_focusedView.setText("");
					et_focusedView
							.addTextChangedListener(MarkEntryScreen_R09.this);
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void calculateGrandTotal() {
				...
				if ( !is_subject_code_special_case) {
					...
					if (!TextUtils.isEmpty(_mark_6_total)) {
						listTotalMarks.add(Float.valueOf(_mark_6_total));
					} else {
						listTotalMarks.add(Float.valueOf("0"));
					}

					if (!TextUtils.isEmpty(_mark_7_total)) {
						listTotalMarks.add(Float.valueOf(_mark_7_total));
					} else {
						listTotalMarks.add(Float.valueOf("0"));
					}

					if (!TextUtils.isEmpty(_mark_8_total)) {
						listTotalMarks.add(Float.valueOf(_mark_8_total));
					} else {
						listTotalMarks.add(Float.valueOf("0"));
					}
					...
					//	String mark;
						...
						if(subjectCode
						   ...
						   if (!listTotalMarks.isEmpty()) {
							...
							if(subjectCode
									.equalsIgnoreCase(SEConstants.SUBJ_58002_DESIGN_AND_DRAWING_OF_IRRIGATION_STRUCTURES_1)){
								ArrayList<Float> listTotalMarks1 = new ArrayList<Float>();
								if (!TextUtils.isEmpty(_mark_3_total)) {
									listTotalMarks1.add(Float.valueOf(_mark_3_total));
								} else {
									listTotalMarks1.add(Float.valueOf("0"));
								}

								if (!TextUtils.isEmpty(_mark_4_total)) {
									listTotalMarks1.add(Float.valueOf(_mark_4_total));
								} else {
									listTotalMarks1.add(Float.valueOf("0"));
								}
								Collections.sort(listTotalMarks1, Collections.reverseOrder());
								//Collections.sort(listTotalMarks);  
									// best of 1 from 2
								...
								for (int a = 0; a < 1; a++)  
									{
										grandTotal += listTotalMarks1.get(a);  
										Log.v("" + listTotalMarks1.size(), "vvv "
												+ listTotalMarks1.get(a));
									}
							}
							else if( subjectCode
							 .equalsIgnoreCase(SEConstants.SUBJ_Q0123_ENGINEERING_DRAWING)){
								...
								if (!TextUtils.isEmpty(_mark_5_total)) {
									listTotalMarks1.add(Float.valueOf(_mark_5_total));
								} else {
									listTotalMarks1.add(Float.valueOf("0"));
								}

								if (!TextUtils.isEmpty(_mark_6_total)) {
									listTotalMarks1.add(Float.valueOf(_mark_6_total));
								} else {
									listTotalMarks1.add(Float.valueOf("0"));
								}

								if (!TextUtils.isEmpty(_mark_7_total)) {
									listTotalMarks1.add(Float.valueOf(_mark_7_total));
								} else {
									listTotalMarks1.add(Float.valueOf("0"));
								}
								Collections.sort(listTotalMarks1, Collections.reverseOrder());
						...
						if (!listTotalMarks.isEmpty()) {
							...
							float mark = Float.parseFloat(TextUtils.isEmpty(_mark_4_total) ? "0" : _mark_4_total);
	...
	public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
		// TODO Auto-generated method stub
		/*
		 * if(!clickFind){ //setTextToFocusedView(arg0.toString()); try{ View
		 * focusedView = getCurrentFocus(); if (focusedView != null &&
		 * focusedView instanceof EditText) { EditText et_focusedView =
		 * ((EditText) focusedView); et_focusedView.setText(""); }
		 * }catch(Exception e){ } clickFind=false;
		 */
	}
	...
	private String row1Total_() {
		...
		if (!is_subject_code_special_case) {
			...
			if (!TextUtils.isEmpty(mark1a) || !TextUtils.isEmpty(mark1b)
				...
				if (!TextUtils.isEmpty(mark)) {
					if (Float.parseFloat(mark) > Float.parseFloat(""
							+ RowTotalLimit)) {
						Toast.makeText(this,
								"Row Total Exceeds " + RowTotalLimit,
								Toast.LENGTH_SHORT).show();
						View focusedView = getCurrentFocus();
						if (focusedView != null
								&& focusedView instanceof EditText) {
							alertForInvalidMark(focusedView, true, " "
									+ RowTotalLimit);
						}
					} else {
			...
			if (subjectCode
				...
				if (!TextUtils.isEmpty(mark1a) || !TextUtils.isEmpty(mark1b)
						|| !TextUtils.isEmpty(mark1c)
						|| !TextUtils.isEmpty(mark1d)) {

					mark = String.valueOf(Float.parseFloat(((TextUtils
							.isEmpty(mark = mark1a))) ? "0" : mark)
							+ Float.parseFloat(((TextUtils
									.isEmpty(mark = mark1b))) ? "0" : mark)
							+ Float.parseFloat(((TextUtils
					...
					if (!TextUtils.isEmpty(mark)) {
						if (subjectCode
							...
							if (Float.parseFloat(mark) > Float.parseFloat(""
									+ RowTotalLimit_2)) {
								Toast.makeText(this,
										"Row Total Exceeds " + RowTotalLimit_2,
										Toast.LENGTH_SHORT).show();
								View focusedView = getCurrentFocus();
								if (focusedView != null
										&& focusedView instanceof EditText) {
	...
	private String row_2_Total_() {
		...
		if (!is_subject_code_special_case) {
			...
			if (subjectCode
				...
				if (!TextUtils.isEmpty(mark2a) || !TextUtils.isEmpty(mark2b)
						|| !TextUtils.isEmpty(mark2c)
						|| !TextUtils.isEmpty(mark2d)) {
	...
	private String row_3_Total_() {
		...
		if (!is_subject_code_special_case) {
			...
			if (subjectCode
				...
				if (!TextUtils.isEmpty(mark3a) || !TextUtils.isEmpty(mark3b)
						|| !TextUtils.isEmpty(mark3c)
						|| !TextUtils.isEmpty(mark3d)) {
					...
					if (!TextUtils.isEmpty(mark)) {
						if (subjectCode
							...
							if (Float.parseFloat(mark) > Float.parseFloat(""
									+ RowTotalLimit_4)) {
								Toast.makeText(this,
										"Row Total Exceeds " + RowTotalLimit_4,
										Toast.LENGTH_SHORT).show();
								View focusedView = getCurrentFocus();
								if (focusedView != null
										&& focusedView instanceof EditText) {
	...
	private String row_4_Total_() {
		...
		if (!is_subject_code_special_case) {
			...
			if (subjectCode
				...
				if (!TextUtils.isEmpty(mark4a) || !TextUtils.isEmpty(mark4b)
						|| !TextUtils.isEmpty(mark4c)
						|| !TextUtils.isEmpty(mark4d)) {
	...
	private String row_5_Total_() {
		...
		_mark_5_total = mark;
		}else if(is_subject_code_special_case && R09BTech){
			if(subjectCode
					.equalsIgnoreCase(SEConstants.SUBJ_Q0123_ENGINEERING_DRAWING) ||
					subjectCode
					.equalsIgnoreCase(SEConstants.SUBJ_T0121_BUILDING_PLANNING_AND_DRAWING_5)){
				...
				if (!TextUtils.isEmpty(mark5a) || !TextUtils.isEmpty(mark5b)
					...
					if (!TextUtils.isEmpty(mark)) {
						...
						if (Float.parseFloat(mark) > Float.parseFloat(""
								+ RowTotalLimit_4)) {
							Toast.makeText(this, "Row Total Exceeds " + RowTotalLimit_4,
									Toast.LENGTH_SHORT).show();
							View focusedView = getCurrentFocus();
							if (focusedView != null && focusedView instanceof EditText) {
								alertForInvalidMark(focusedView, true, " "
