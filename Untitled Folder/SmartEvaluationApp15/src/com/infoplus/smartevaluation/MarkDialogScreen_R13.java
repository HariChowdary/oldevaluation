...
public class MarkDialogScreen_R13 extends Activity implements OnClickListener {
	...
	private void showItems() {
		...
		if (cursor.getCount() > 0) {
			for (cursor.moveToFirst(); !(cursor.isAfterLast()); cursor
				...
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK1F)),
						((EditText) findViewById(R.id.q1_f)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK1G)),
						((EditText) findViewById(R.id.q1_g)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK1H)),
						((EditText) findViewById(R.id.q1_h)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK1I)),
						((EditText) findViewById(R.id.q1_i)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK1J)),
...
//						((TextView) findViewById(R.id.q6_7_total)));
				...
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK9C)),
...
//						((TextView) findViewById(R.id.q8_9_total)));
				...
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK10C)),
						((EditText) findViewById(R.id.q10_c)));
				// Marks11
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK11A)),
						((EditText) findViewById(R.id.q11_a)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK11B)),
						((EditText) findViewById(R.id.q11_b)));
				setMarkToCellFromDB(cursor.getString(cursor
						.getColumnIndex(SEConstants.MARK11C)),
